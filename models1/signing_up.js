...
module.exports.singing_up = function (req, res) {
    ...
    let link = 'http://localhost:3000' + '/api/v1/verify?id=' + activeToken + '&email=' + mailid;
    ...
    let mailOption = {
        ...
        html: 'Hello, <br> Please Click on the link to verify your email.<br> click <a href="' + link + '"> here </a> to verify.',
    };
